...
const Footer: React.FC = () => (
  <footer className="border-t border-border px-6 md:px-0 pt-8 pb-2 bg-black text-gray-400 text-sm">
    <div className="max-w-3xl mx-auto pb-12 flex flex-col md:flex-row justify-between items-stretch gap-8 px-4 md:px-0">
    ...
    <div className="max-w-3xl mx-auto border-t border-border py-4 md:py-2 px-4 md:px-0 bg-black text-gray-400 flex flex-col md:flex-row items-center justify-between gap-2 text-xs">
